    ...
    <ul class="m-0 flex w-max list-none items-center gap-3 p-0">
      ...
      <li v-for="item in items" :key="item" class="m-0 list-none p-0">
        <span
          ...
          class="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-md border border-black-200 bg-white text-omicron font-semibold text-black-800"
          aria-hidden="true"
        >
          ...
        </span>
