...
function parsePersentase(value: string | number | null | undefined) {
...
function formatPersentase(value: number | null | undefined) {
    ...
    <template v-if="(internalValue !== null && !disabled) || $slots['right-icon']" #right-icon>
      <slot name="right-icon">
        <button
          ...
          type="button"
          class="pointer-events-auto flex items-center justify-center cursor-pointer focus:outline-none"
          @click="updateValue(null)"
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="12" cy="12" r="9.54545" stroke="#58585B" stroke-width="0.909091"/>
